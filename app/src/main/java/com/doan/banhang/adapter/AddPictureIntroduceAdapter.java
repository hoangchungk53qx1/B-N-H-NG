...
public class AddPictureIntroduceAdapter extends RecyclerView.Adapter<AddPictureIntroduceAdapter.ViewHolder>{
    ...
    public AddPictureIntroduceAdapter(ArrayList<String> arrayPicture) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        switch (i){
            case TYPE_PREVIEW_IMAGE:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_image_product,viewGroup,false);
                break;
            case TYPE_PREVIEW_ADD_IMAGE:
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_add_image_order,viewGroup,false);
                break;
        }
